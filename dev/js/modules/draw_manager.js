export function draw_text(_ctx, _text, _font, _size, _align, _color, _a, _pos){
    _ctx.globalAlpha = _a;
...
export function draw_box(_ctx, _size, _color, _a, _pos){
    _ctx.globalAlpha = _a;
    _ctx.fillStyle = _color;
...
export function draw_bevel_outline(_ctx, _x, _y, _w, _h, _r, _color, _a){
    _ctx.beginPath();
...
export function draw_image(_ctx, _image, _frame, _pos, _size, _rot, _spriteSize, _a){
    _ctx.globalAlpha = _a;
